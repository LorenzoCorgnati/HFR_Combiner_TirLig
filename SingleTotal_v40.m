...
function [sT_err] = SingleTotal_v40(ruv_files, when, lon_lim, lat_lim, Grid, spatthresh, Radial_QC_params, Total_QC_params, range_cells_number, mask_cst, dest_maps, dest_tuvs, dest_serv_tuvs, src_folder, serv_maps, serv_netcdf)

display(['[' datestr(now) '] - - ' 'SingleTotal_v40.m started.']);
